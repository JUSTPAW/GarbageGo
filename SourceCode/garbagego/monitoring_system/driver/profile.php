...
require '../db_conn.php';
   ...
   if (isset($_POST['submit'])) {
    ...
    if (!in_array($extension, $allowed_extensions)) {
        ...
        $query = mysqli_query($conn, "UPDATE drivers SET image='$imgnewfile' WHERE id='$id'");
...
<!--         <div class="d-sm-flex align-items-center justify-content-between mb-1 mt-1">
 ...
 -->
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" enctype="multipart/form-data" id="imageForm">
                            <?php
                            $id = $_SESSION['id'];
                            $ret = mysqli_query($conn, "SELECT * FROM drivers WHERE id='$id'");
        ...
        <!-- Edit Account -->
        <div class="modal fade" id="edit_account" tabindex="-1" role="dialog" aria-labelledby="editDriverModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title font-weight-bold text-gray-800" id="editDriverModalLabel">Edit Profile</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
        ...
        <div class="modal fade" id="delete_account" tabindex="-1" role="dialog" aria-labelledby="deleteDriverModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title font-weight-bold text-gray-800" id="deleteDriverModalLabel">Delete Account</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
...
$sql = "SELECT * FROM drivers WHERE user_name = '$user_name'";
