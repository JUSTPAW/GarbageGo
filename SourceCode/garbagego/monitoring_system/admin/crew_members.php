                    ...
                    <div class="modal-body">
                        <form action="crud_crew.php" method="POST">
                            ...
                            <div class="form-row mt-2">
                                ...
                                <div class="form-group col-md-4 mt-2">
                                    <input type="tel" class="form-control" id="phone" name="phone" placeholder=" " maxlength="11">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="crud_crew.php" method="POST">
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-4 mt-2">
                      <input type="date" class="form-control" id="edit_birthday" name="edit_birthday" placeholder=" ">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    Swal.fire({
                        icon: 'success',
                        title: 'Deleted!',
                        text: 'The crew member has been deleted successfully.',
                        showConfirmButton: false,
